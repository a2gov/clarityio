...
- Do not bump the version in `pyproject.toml` unless explicitly asked.
- CHANGELOG entries go under `## NEXT` until a release decision is made. Do not create a versioned section (e.g. `## v1.0.1`) unless explicitly asked to cut a release.
